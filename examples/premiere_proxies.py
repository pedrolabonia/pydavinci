# import time
# from py-resolve.resolve import Resolve
...
#         timeline.set_setting('useCustomSettings', '1') # enable custom timeline size != project settings
...
# job_ids = generate_premiere_proxies('/Users/pedrolabonia/Documents/media_tests', 2, '/Users/pedrolabonia/Documents/media_tests/output')
...
#         print(f'Job ID {job_ids[i]} | Rendering time left: {time_left} | Percentage completed: {percentage}%\r', end='', flush=True)
