...
class PyRemoteProject(object):
    ...
    def StartRendering(self, jobids: List[str], isInteractiveMode: bool = ...) -> bool: ...
    ...
    def GetRenderResolutions(self, format: str, codec: str) -> List[Dict[Any, Any]]: ...
...
class PyRemoteMediaPool(object):
    ...
    def ImportTimelineFromFile(
        self, filePath: str, options: Dict[Any, Any]
    ) -> "PyRemoteTimeline": ...
    ...
    def ExportMetadata(self, fileName: str, clips: List["PyRemoteMediaPoolItem"]) -> bool: ...
...
class PyRemoteMediaPoolItem(object):
    def GetName(self) -> str: ...
    def GetMetadata(self, metadataType: Optional[str]) -> Union[Dict[Any, Any], str]: ...
    ...
    def UpdateMarkerCustomData(self, frameId: str, customData: str) -> bool: ...
...
class PyRemoteTimeline(object):
    ...
    def GetItemListInTrack(self, trackType: str, index: str) -> List["PyRemoteTimelineItem"]: ...
    def AddMarker(
        self, frameid: int, color: str, name: str, note: str, duration: int, customData: str
    ) -> bool: ...
    def GetMarkers(self) -> Dict[Any, Any]: ...
    ...
    def DuplicateTimeline(self, timelineName: str) -> "PyRemoteTimeline": ...
    def CreateCompoundClip(
        self, items: List["PyRemoteTimelineItem"], clipinfo: Dict[Any, Any]
