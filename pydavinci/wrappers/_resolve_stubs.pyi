...
class PyRemoteGalleryStillAlbum(object):
    ...
    def GetLabel(self, galleryStill) -> str: ...
    def SetLabel(self, galleryStill, label) -> bool: ...
    def ExportStills(self, galleryStill:List["PyRemoteGalleryStill"], folderPath:str, filePrefix:str, format) -> bool: ...
    def DeleteStills(self, galleryStill: List["PyRemoteGalleryStill"]) -> bool: ...

        
class PyRemoteGallery(object):
    def GetAlbumName(self, galleryStillAlbum: str) -> str: ...
    def SetAlbumName(self, galleryStillAlbum: str, albumName: str) -> bool: ...
    def GetCurrentStillAlbum(self) -> str: ...
